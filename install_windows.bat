...
if defined VIRTUAL_ENV (
    ...
    pip install setuptools_rust>=1.1 numpy>=1.21.0 matplotlib>=3.5.0 pillow>=8.0.0 requests>=2.25.0 docopt>=0.6.2
    if !errorlevel! neq 0 (
        echo WARNING: Failed to install some dependencies, continuing anyway...
    )
    
    echo Building SonarSniffer with Rust extensions...
    pip install -e .
