...
```
Subject: SAR Platform Survey - Community Input Needed (Deadline: Dec 10)

Hi [Team Name/SAR Community],

We're developing a unified Search & Rescue platform and need YOUR feedback to get it right.

Please complete the SAR Platform Survey by December 10, 2025.
...
3. **Send the email**:
   ...
   - Send to all SAR teams by December 10, 2025
